        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SyntaxHighlighting = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChallengeLanguages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChallengeLanguages_Challenges_ChallengeId",
                        column: x => x.ChallengeId,
                        principalTable: "Challenges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChallengeLanguages_Languages_LanguageId",
            ...
            migrationBuilder.InsertData(
                table: "Languages",
                columns: new[] { "Id", "Extension", "IsActive", "Name", "SyntaxHighlighting", "Version" },
                values: new object[,]
                {
                    { 1, ".cs", true, "C#", "csharp", "12.0" },
                    { 2, ".py", true, "Python", "python", "3.11" },
                    { 3, ".js", true, "JavaScript", "javascript", "ES2023" },
                    { 4, ".java", true, "Java", "java", "17" },
                    { 5, ".cpp", true, "C++", "cpp", "20" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChallengeLanguages_ChallengeId_LanguageId",
                table: "ChallengeLanguages",
                columns: new[] { "ChallengeId", "LanguageId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChallengeLanguages_LanguageId",
                table: "ChallengeLanguages",
                column: "LanguageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Challenges_DifficultyLevel",
                table: "Challenges",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Solutions_SubmittedAt",
                table: "Solutions",
                column: "SubmittedAt");

            migrationBuilder.CreateIndex(
                name: "IX_Solutions_UserId_ChallengeId",
                table: "Solutions",
